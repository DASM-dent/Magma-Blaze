      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-start">
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-end gap-3">
            ...
            {compare ? <span className="text-white/30 line-through pb-1">{symbol} {Number(compare).toLocaleString('es-DO', { minimumFractionDigits: currency === 'USD' ? 2 : 0, maximumFractionDigits: currency === 'USD' ? 2 : 0 })}</span> : null}
          </div>
