...
const translations: { es: Record<string, string> } = {
  es: {
    ...
    'addresses.city': 'Municipio',
    'addresses.cityHint': 'La lista cambia según la provincia seleccionada.',
    ...
    'news.copy': 'Descubre nuevos lanzamientos, colecciones, drops especiales y todo lo que está por llegar a Magma Blaze.',
    ...
    'models.title': 'Modelo',
    'models.copy': 'Fotos de nuestros modelos usando los artículos, toca cada etiqueta para ir al artículo que completa el look de la imagen.',
