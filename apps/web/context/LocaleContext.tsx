...
const translations: Record<StoreLanguage, Record<string, string>> = {
  es: {
    ...
    'product.shippingLine': 'Envios disponibles para Republica Dominicana y Estados Unidos.',
    'product.confirmLine': 'Si el envio no tiene tarifa registrada, quedara pendiente de confirmacion.',
    ...
    'checkout.verifyAvailability': 'Enviar consulta por WhatsApp',
  ...
  en: {
    ...
    'checkout.verifyAvailability': 'Send inquiry on WhatsApp',
